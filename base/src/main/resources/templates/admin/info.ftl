				...
				<div class="alert alert-danger">${message!}</div>
                    ...
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/regist">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="userName" name="userName" class="form-control" type="text" placeholder="请输入您的真实姓名。" value="${user.userName}" <#if user?exists> readonly="readonly"</#if>>
                            </div>
                        </div>
