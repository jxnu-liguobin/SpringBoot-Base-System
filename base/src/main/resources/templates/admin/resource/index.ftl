        ...
        $(document).ready(function () {
			...
			$("#table_list").bootstrapTable({
			    ...
			    columns: [{
			        ...
			        align: "center",
                    formatter: function (value, row, index) {
                    	var operateHtml = '<@shiro.hasPermission name="system:resource:edit">&nbsp;&nbsp;<button class="btn btn-primary btn-xs" type="button" onclick="edit(\''+row.id+'\')"><i class="fa fa-edit"></i>&nbsp;修改&nbsp;</button> &nbsp;</@shiro.hasPermission>';
